...
export const SearchInput = ({ className }: { className?: ClassValue }) => {
	...
	return (
		<div className={clsx("row flex items-center rounded-md border border-gray-300", className)}>
			<Search size={16} className="pointer-events-none w-10 stroke-slate-500" />
			<input
				placeholder="Search"
